...
export const NavbarLogo = () => {
  return (
    ...
    >
      ...
      <span className="font-bold text-black dark:text-white">ANUJ.AI</span>
    </a>
  );
};
...
export const NavbarButton = ({
  ...
  const variantStyles = {
    ...
    gradient:
      "bg-gradient-to-b from-cyan-500 to-blue-700 text-white shadow-[0px_2px_0px_0px_rgba(255,255,255,0.3)_inset]",
  };
