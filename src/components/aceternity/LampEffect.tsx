...
export function LampContainer({
  ...
  return (
    <div
      className={`relative flex min-h-[340px] flex-col items-center justify-center overflow-hidden w-full rounded-md z-0 ${
        className || ""
      }`}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        <div className="absolute top-1/2 h-48 w-full translate-y-12 scale-x-150 bg-[#07080a] blur-2xl" />
        ...
        <motion.div
          ...
          className="absolute inset-auto z-50 h-0.5 w-[30rem] -translate-y-[7rem] bg-cyan-400 shadow-[0_0_20px_rgba(0,229,255,1)]"
        />

        <div className="absolute inset-auto z-40 h-44 w-full -translate-y-[12.5rem] bg-[#07080a] " />
      </div>
